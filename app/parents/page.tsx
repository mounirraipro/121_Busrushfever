...
export const metadata: Metadata = {
    ...
    description: 'Bus Rush Fever is a safe, educational, and family-friendly game. Learn how we protect children and promote healthy screen time.',
    keywords: ['Bus Rush Fever for kids', 'safe game', 'children online safety', 'educational game', 'family friendly games'],
};
        ...
        <>
            <div className="page-header">
                <div className="container">
                    ...
                    <p>Everything parents need to know about Bus Rush Fever and online safety.</p>
                </div>
            </div>
            ...
            <div className="page-content">
                ...
                <p>
                    Bus Rush Fever is a family-friendly game created to provide wholesome entertainment
                    for players of all ages. We understand that parents care deeply about what their children
                    do online, and we&apos;ve built Bus Rush Fever with safety, education, and fun as our core priorities.
                </p>
                ...
                <p>
                    ...
                    children and adults alike. Here&apos;s what your child gains from playing Bus Rush Fever:
                </p>
                <ul>
                ...
                <p>
                    Bus Rush Fever does not collect any personal information from children. There are no
                ...
                <p>
                    Bus Rush Fever is completely free to play with no hidden costs. There are no virtual
                ...
                <p>
                    All content used in Bus Rush Fever is carefully curated to be appropriate for all ages.
                    All content in Bus Rush Fever is carefully selected to be appropriate for all ages.
                </p>

                <h3>Advertisements</h3>
                <p>
                    Bus Rush Fever displays advertisements to support the free service. These ads are served
                ...
                <p>
                    We take the Children&apos;s Online Privacy Protection Act (COPPA) seriously. Bus Rush Fever
                ...
                <p>
                    While Bus Rush Fever is designed to be safe, we encourage parents to take an active role
                ...
                <ol>
                    ...
                    <li><strong>Discuss online safety:</strong> Use Bus Rush Fever as a starting point to talk about safe internet habits.</li>
                ...
                <h2>Have Concerns?</h2>
                <p>
                    If you have any questions or concerns about your child&apos;s experience on Bus Rush Fever,
